...
<div style="height: 50px;background: lightblue;"></div>
  ...
  <table>
   ...
   <tr><th>やってみたい分野</th><td>{{Form::select('category', [ 'インフラ' => 'インフラ', 'マネジメント' => 'マネジメント', 'backend' =>'backend', 'frontend' =>'frontend'])}}</td></tr>
   ...
   <tr><th>使用しているOS</th><td>{{Form::select('os', ['WINDOWS' => 'WINDOWS', 'MACBOOK' => 'MACBOOK', 'Ubuntu' =>'Ubuntu', 'Centos7' =>'Centos7','Soralis' =>'Soralis','Linuxmint' =>'Linuxmint'])}}</td></tr>
